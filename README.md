...
Por fim podemos sintetizar que o sistema de compra de passagens aéreas foi desenvolvido utilizando comunicação TCP/IP e contêineres Docker, garantindo que múltiplos clientes possam consultar e reservar trechos de voos de forma eficiente e simultânea. O sistema atingiu o objetivo de oferecer uma solução sem frameworks de troca de mensagens, utilizando um protocolo customizado e adotando uma arquitetura stateful para manter o controle das reservas. No entanto, uma possível melhoria futura seria otimizar ainda mais o paralelismo e a escalabilidade com o uso de balanceamento de carga entre instâncias de servidores.

Ao longo do desenvolvimento, o aprendizado adquirido foi amplo, especialmente em áreas como o controle de concorrência e a comunicação direta entre clientes e servidores via sockets TCP. Além disso, o uso de Docker trouxe insights sobre como contêineres podem facilitar o processo de teste, implantação e escalabilidade de sistemas distribuídos. O trabalho com um sistema stateful também mostrou a importância de garantir a consistência dos dados em ambientes com múltiplos usuários simultâneos. O conhecimento adquirido pode ser aplicado em diversos cenários, desde o desenvolvimento de outros sistemas que exigem comunicação eficiente em tempo real até a otimização de serviços baseados em contêineres. Além disso, a experiência com controle de concorrência e sincronização pode ser estendida para outras soluções de software onde a consistência dos dados e o desempenho são críticos.
